...
const _DocumentInformation = () => {
    ...
    const doDocument = () => {
        ...
        let purchaseOrder = document.getElementById("ViewModel_PurchaseOrder").value;
        ...
        document.getElementById("purchase-order").textContent = purchaseOrder;
        ...
        document.getElementById("Invoice_PurchaseOrder").value = purchaseOrder.toString();
        document.getElementById("Invoice_SerialNo").value = docNo;
        document.getElementById("Invoice_Date").value = date;
        document.getElementById("Invoice_DueDate").value = dueDate;
...
const _Product = () => {
    ...
    const calculateProduct = () => {
        ...
        document.getElementById("Invoice_Tax").value = tax;
        ...
        document.getElementById("Invoice_ShippingFee").value = shipping;
        compileProduct();
    }
    ...
    const doProduct = () => {
        ...
        $.ajax({
            url: '/Stocks/RenderInvoiceProductPartialView',
            type: "POST",
    ...
    const compileProduct = () => {
        ...
        let stockInput = document.getElementById("Invoice_Stocks");
...
const _formSetup = () => {
    ...
    const submitData = () => {
        ...
        formData["Invoice.Stocks"] = Stocks;
    ...
    const assignValue = () => {
        document.getElementById("Invoice_Id").value = documentId;
        document.getElementById("Invoice_SerialNo").value = document.getElementById("ViewModel_SerialNo").value;
        document.getElementById("Invoice_CustomerId").value = customerId;
        document.getElementById("Invoice_Date").value = document.getElementById("ViewModel_Date").value;
        document.getElementById("Invoice_DueDate").value = document.getElementById("ViewModel_DueDate").value;
        document.getElementById("Invoice_Subtotal").value = document.getElementById("ViewModel_Subtotal").value;
        document.getElementById("Invoice_Tax").value = document.getElementById("ViewModel_Tax").value;
        document.getElementById("Invoice_ShippingFee").value = document.getElementById("ViewModel_ShippingFee").value;
        document.getElementById("Invoice_Price").value = document.getElementById("ViewModel_Price").value;
        document.getElementById("Invoice_PurchaseOrder").value = document.getElementById("ViewModel_PurchaseOrder").value;
    }
