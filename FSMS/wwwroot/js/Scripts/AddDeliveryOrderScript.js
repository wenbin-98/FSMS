...
const _Customer = () => {
    ...
    const bindDropdown = () => {
        ...
        $('#ViewModel_CustomerId').on('select2:select', function (e) {
            ...
            document.getElementById("DeliveryOrder_CustomerId").value = data.id;
        });
    }
    ...
    const resetForm = () => {
        document.getElementById("DeliveryOrder_CustomerId").value = tempdata;
        $("#ViewModel_CustomerId").val('').trigger('change');
        customerId = tempdata;
    }

    const initTempData = () => {
        tempdata = document.getElementById("DeliveryOrder_CustomerId").value;
    }
